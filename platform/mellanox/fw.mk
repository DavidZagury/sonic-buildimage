...
MLNX_FW_BASE_URL = http://fit69.mtl.labs.mlnx//auto/sw_system_release/sx_mlnx_fw
...
$(MLNX_SPC_FW_FILE)_URL = $(MLNX_FW_BASE_URL)/SPC/$(MLNX_SPC_FW_FILE)

MLNX_SPC2_FW_VERSION = 29.2010.2320
MLNX_SPC2_FW_FILE = fw-SPC2-rel-$(subst .,_,$(MLNX_SPC2_FW_VERSION))-EVB.mfa
$(MLNX_SPC2_FW_FILE)_PATH = $(MLNX_FW_BASE_PATH)
$(MLNX_SPC2_FW_FILE)_URL = $(MLNX_FW_BASE_URL)/SPC2/$(MLNX_SPC2_FW_FILE)

MLNX_SPC3_FW_VERSION = 30.2010.2320
MLNX_SPC3_FW_FILE = fw-SPC3-rel-$(subst .,_,$(MLNX_SPC3_FW_VERSION))-EVB.mfa
$(MLNX_SPC3_FW_FILE)_PATH = $(MLNX_FW_BASE_PATH)
$(MLNX_SPC3_FW_FILE)_URL = $(MLNX_FW_BASE_URL)/SPC3/$(MLNX_SPC3_FW_FILE)
