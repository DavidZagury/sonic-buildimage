...
ifeq ($(INCLUDE_BASE_GNMI), y)
SONIC_INSTALL_DOCKER_IMAGES += $(DOCKER_BASE_GNMI)
endif

SONIC_DOCKER_DBG_IMAGES += $(DOCKER_BASE_GNMI_DBG)
ifeq ($(INCLUDE_BASE_GNMI), y)
SONIC_INSTALL_DOCKER_DBG_IMAGES += $(DOCKER_BASE_GNMI_DBG)
endif
